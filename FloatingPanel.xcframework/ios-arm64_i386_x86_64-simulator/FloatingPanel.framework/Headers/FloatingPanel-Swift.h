...
#ifndef FLOATINGPANEL_SWIFT_H
#define FLOATINGPANEL_SWIFT_H
...
- (UIViewController * _Nullable)childViewControllerForScreenEdgesDeferringSystemGestures SWIFT_WARN_UNUSED_RESULT;
- (UIViewController * _Nullable)childViewControllerForHomeIndicatorAutoHidden SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC13FloatingPanel17FloatingPanelCore")
@interface FloatingPanelCore : NSObject <UIGestureRecognizerDelegate>
